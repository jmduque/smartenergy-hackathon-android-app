...
import com.energolabs.evergo.modules.settings.viewHolders.SettingsItemViewHolder
...
class SettingsItemViewModel(
        activity: Activity?,
        item: SettingsItem?
) : BaseViewModel<SettingsItemViewHolder, SettingsItem>(
        activity,
        item
) {

    override fun getLayoutRes(): Int {
        return R.layout.item_settings_item
    }
