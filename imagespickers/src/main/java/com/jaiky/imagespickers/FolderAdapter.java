...
public class FolderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (holder != null) {
            if (position == 0) {
                holder.folder_name_text.setText(R.string.imagepicker_all_folder);
                holder.image_num_text.setText("" + getTotalImageSize() + (context.getResources().getText(R.string.imagepicker_sheet)));
                ...
                holder.image_num_text.setText("" + folder.images.size() + (context.getResources().getText(R.string.imagepicker_sheet)));
