...
public class ImageSelectorActivity extends FragmentActivity implements ImageSelectorFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.hideTitleBar(
                this,
                R.id.imageselector_activity_layout,
    ...
    private void init() {
        ...
        if (pathList == null || pathList.size() <= 0) {
            submitButton.setText(getResources().getString(R.string.imagepicker_finish));
            submitButton.setEnabled(false);
        } else {
            submitButton.setText(getResources().getString(R.string.imagepicker_finish) + "(" + pathList.size() + "/" + imageConfig.getMaxSize() + ")");
